...
Path tracer with direct sensor connection (:monosp:`pathconnect`)
-----------------------------------------------------------------
...
class PathConnectIntegrator : public MonteCarloIntegrator<Float, Spectrum> {
public:
    ...
    PathConnectIntegrator(const Properties &props) : Base(props) { }
    ...
    std::string to_string() const override {
        return tfm::format("PathConnectIntegrator[\n"
            "  max_depth = %i,\n"
            "  rr_depth = %i\n"
...
MTS_IMPLEMENT_CLASS_VARIANT(PathConnectIntegrator, MonteCarloIntegrator)
MTS_EXPORT_PLUGIN(PathConnectIntegrator, "Path Tracer integrator");
