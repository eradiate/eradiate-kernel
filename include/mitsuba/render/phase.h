...
/**
 * \brief This enumeration is used to classify phase functions into different
 * types, i.e. into isotropic, anisotropic and microflake phase functions.
 *
...
enum class PhaseFunctionFlags : uint32_t {
    ...
    /// Anisotropic (at least one lobe)
    Anisotropic = 0x02,

    /// Microflake
    Microflake = 0x04,

    /// Any kind of scattering phase function
    All = Isotropic | Anisotropic | Microflake
};
 ...
 *
 * Phase function models in Mitsuba can be queried and sampled using a variety
 * of different modes. Using this data structure, a rendering algorithm can
 * indicate whether radiance or importance is being transported.
 *
...
public:
     ...
     *     the field <tt>mi.wi</tt>.
     *
     * \return The projected area in direction <tt>mi.wi</tt> at position
     * <tt>mi.p</tt>
     */
...
std::ostream &operator<<(std::ostream &os,
                         const PhaseFunctionContext<Float, Spectrum> &ctx) {
